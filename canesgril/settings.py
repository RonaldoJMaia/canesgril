...
STATIC_ROOT = BASE_DIR / 'ataticfiles'
...
# Adiciona o dominio base do Railway e qualquer dominio personalizado
CSRF_TRUSTED_ORIGINS = [
    'https://*.railway.app', #Para cobrir seu dominio Railway padrão
